      ...
      <div className={Styles.container}> 
            <div className={Styles.mainDiv} style={{padding: 0}}>
                <div className={classes.settings}>
                    <Grid container justify="space-between" alignItems="center" className={classes.setting}>
                        <Grid item>Dark Mode</Grid>
                        <Grid item>
                            <FormControlLabel
                                control={<IOSSwitch checked={state.darkMode} 
                                onChange={handleChange} name="darkMode" />}
                            />
                        </Grid>
                    </Grid>
                    <Grid container justify="space-between" alignItems="center" className={classes.setting}>
                        ...
                        <Grid item>
                            <FormControlLabel
                                control={<IOSSwitch checked={state.fullscreen} 
                                onChange={handleChange} name="fullscreen" />}
                            />
                        </Grid>
                    </Grid>
                    <Grid container justify="space-between" alignItems="center" className={classes.setting}>
                        ...
                        <Grid item>
                            <FormControlLabel
                                control={<IOSSwitch checked={state.showActive} 
                                onChange={handleChange} name="showActive" />}
                            />
                        </Grid>
                    </Grid>
                </div>
