...
const Calender = () => {
 ...
 const attendanceList = [
  '2-0-2021','7-0-2021','3-0-2021',
  '15-0-2021','17-0-2021','12-0-2021',
  '20-0-2021','28-0-2021','28-0-2021',
  '31-0-2021','3-1-2021','6-1-2021',
  '7-1-2021','11-1-2021','16-1-2021',
  '22-1-2021','25-1-2021','27-1-2021',
]
          ...
          <div
            className={`${styles.col} ${styles.cell} ${
              ...
              !dateFns.isSameMonth(day, monthStart)
                ? styles.disabled
                : attendanceArray.find(dt => JSON.stringify(dt) === JSON.stringify(day)) 
                  ? styles.selected
                  : "" 
            }`}
            key={day}
