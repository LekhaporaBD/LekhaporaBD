...
const ForgotPass = ({handleClose}) => {
    const userData = useSelector(({ui}) => (ui.authToken.user))
        ...
        <div>
            <div className={Classes.switch} >
                ...
                <div className={Classes.container} >
                    ...
                    <p className={`${Classes.description}`}> {userData ? "You succesfully submitted One document." : 'Please Connect With Your Admin For This Help.' }  </p>
